...
public class DbPath {
    public static final String USER_SCHEMA = "mst_users";
    public static final String DIVISION_SCHEMA = "mst_divisions";
    public static final String ROLE_SCHEMA = "mst_roles";
    public static final String USER_CREDENTIAL_SCHEMA = "mst_user_credentials";
    public static final String USER_PROFILE_SCHEMA = "mst_user_profiles";
